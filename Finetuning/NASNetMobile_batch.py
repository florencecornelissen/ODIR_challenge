...
print('--------------------------- NASNetMobile batch tuning -------------------------------')
...
checkpoint_directory = f'./CheckpointNASNetMobile_batch/'

if not os.path.exists(checkpoint_directory):
    os.mkdir(checkpoint_directory)

checkpoint_filepath = './CheckpointNASNetMobile_batch'
...
best_model.save('best_model_finetuning_NASNetMobile_batch.keras')
with open('best_hyperparameters_batch.txt', 'w') as f:
    f.write('Batchsize: \n')
