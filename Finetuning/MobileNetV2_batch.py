...
from keras.applications import ResNet50, VGG19, MobileNetV2
...
print('--------------------------- MobileNetV2 batch tuning with layer removed -------------------------------')
...
checkpoint_directory = f'./CheckpointMobileNetV2_batch/'

if not os.path.exists(checkpoint_directory):
    os.mkdir(checkpoint_directory)

checkpoint_filepath = './CheckpointMobileNetV2_batch'
...
best_model.save('best_model_finetuning_MobileNetV2_batch.keras')
with open('best_hyperparameters_batch_mobileNetV2.txt', 'w') as f:
    f.write('Batchsize: \n')
