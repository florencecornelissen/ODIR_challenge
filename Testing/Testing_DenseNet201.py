...
print('Final combined testing DenseNet201 with 200 epoch - patience 20')
...
checkpoint_directory = './CheckpointDenseNet201_combined200epoch/'

if not os.path.exists(checkpoint_directory):
    os.mkdir(checkpoint_directory)

checkpoint_filepath = './CheckpointDenseNet201_combined200epoch'
...
plt.title('Training and Validation Accuracy DenseNet201 finetuned')
...
plt.ylabel('Loss')
# plt.ylim([0,1.0])
plt.title('Training and Validation Loss DenseNet201 finetuned')
plt.xlabel('epoch')
plt.savefig('finetuned_DenseNet201200epoch.png')
...
testdf.to_csv('submissionDenseNet201_final200epoch.csv', index=False)