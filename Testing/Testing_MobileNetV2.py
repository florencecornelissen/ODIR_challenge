...
print('Final combined testing MobileNetV2 with 200 epochs - patience 20')
...
checkpoint_directory = './CheckpointMobileNetV2_combined200epochs/'

if not os.path.exists(checkpoint_directory):
    os.mkdir(checkpoint_directory)

checkpoint_filepath = './CheckpointMobileNetV2_combined200epochs'
...
plt.title('Training and Validation Accuracy MobileNetV2 finetuned')
...
plt.ylabel('Loss')
# plt.ylim([0,1.0])
plt.title('Training and Validation Loss MobileNetV2 finetuned')
plt.xlabel('epoch')
plt.savefig('finetuned_MobileNetV2_200epochs.png')
...
testdf.to_csv('submissionMobileNetV2_final200epochs.csv', index=False)