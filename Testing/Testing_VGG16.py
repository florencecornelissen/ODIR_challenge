...
from keras.applications import ResNet50, VGG19, DenseNet201, NASNetMobile, VGG16
from tensorflow.keras.utils import Sequence
from tensorflow.keras.models import Model
from keras.models import load_model
import pickle

print('Final combined testing VGG16 with 200 epochs - patience 20')
...
print('This is with VGG16 batch best test metrics')
...
checkpoint_directory = './CheckpointVGG16_200epochs/'

if not os.path.exists(checkpoint_directory):
    os.mkdir(checkpoint_directory)

checkpoint_filepath = './CheckpointVGG16_200epochs'
...
plt.title('Training and Validation Accuracy VGG16 finetuned')
...
plt.ylabel('Loss')
# plt.ylim([0,1.0])
plt.title('Training and Validation Loss VGG16 finetuned')
plt.xlabel('epoch')
plt.savefig('finetuned_VGG16_200epochs.png')
...
testdf.to_csv('submissionVGG16_final200epochs.csv', index=False)